...
function Body() {
    ...
    <section class="lead section__inner">
     ...
     <img src="/image/sygnet.png" className="logo" alt=""/> 
     <p className="par" >Making the healthcare experience more human</p>
     </section>
     <div class="grid d-flex">
			<div class="col-md-6 pag">
				<p>
       ...
       <section class="services-section-inner">
		<div class="grid fade-elements">
			...
			<div class="col-3">
				<div classname="services__item services__item--saas">
					<div>
			...
			<div className="col-3">
				<div className="services__item services__item--clinics">
					<div>
	...
	{/* <section className="brands section__inner">
		<h1>
			We are a global company
			<br/> with local culture</h1>
	  ...
	  <section className= "stats">
		<div className="section__inner">
			...
			<div class="grid">
				<header class="col- stats__header">
                    <Row>
						<Col md={6}>
							<h1>
								The world's biggest
		...
		<div class="offices__slider">
					...
					<a href="/career?&loc=spain#jobs-offers" class="office__inner">
						...
						<div class="office__desc">
							...
							<div class="office">
					<a href="/career?&loc=rome#jobs-offers" class="office__inner">
						<figure class="office__image">
